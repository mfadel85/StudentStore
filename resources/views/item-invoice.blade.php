    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="item">
                ...
                <td>
                    <center>
                        {{env('SYSTEM_CURRENCY', '₺')}}{{$order->price}} 
                    </center>
                </td>

                <td>
                    <center>
                        {{env('SYSTEM_CURRENCY', '₺')}}{{$order->quantity * $order->price}}
                    </center>
                </td>
            </tr>
            ...
            <tr class="total">
                ...
                <td>
                   <strong><center>{{env('SYSTEM_CURRENCY', '₺')}}{{ $order->used_item_reward_points * $appsetting->customer_rewards_pt_value }}</center></strong>
                </td>
            </tr>
            ...
            <tr class="total">
                ...
                <td>
                   <strong><center>{{env('SYSTEM_CURRENCY', '₺')}}{{$order->quantity * $order->price}}</center></strong>
                </td>
            </tr>
            ...
            <tr class="total">
                ...
                <td>
                   <strong><center>{{env('SYSTEM_CURRENCY', '₺')}}{{ $order->quantity * $order->price - ($order->used_item_reward_points * $appsetting->customer_rewards_pt_value) }}</center></strong>
                </td>
            </tr>
            ...
            @if(\Auth::user()->user_type_id==1)
                <tr class="total">
                    ...
                    <td>
                       <strong><center>{{env('SYSTEM_CURRENCY', '₺')}}{{ $order->student_store_commission }}</center></strong>
                    </td>
                </tr>
                ...
                <tr class="total">
                    ...
                    <td>
                       <strong><center>{{env('SYSTEM_CURRENCY', '₺')}}{{ $order->cool_company_commission }}</center></strong>
                    </td>
                </tr>
                ...
                <tr class="total">
                    ...
                    <td>
                       <strong><center>{{env('SYSTEM_CURRENCY', '₺')}}{{ $order->earned_reward_points * $appsetting->single_rewards_pt_value }}</center></strong>
                    </td>
                </tr>
                ...
                <tr class="total">
                    ...
                    <td>
                       <strong><center>{{env('SYSTEM_CURRENCY', '₺')}}{{ $order->amount_transferred_to_vendor }}</center></strong>
                    </td>
                </tr>
            @endif
        </table>
