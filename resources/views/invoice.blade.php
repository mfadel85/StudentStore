    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="item">
                ...
                <td>
                    <center>
                        {{env('SYSTEM_CURRENCY', '₺')}}{{$item->price}}
                    </center>
                </td>

                <td>
                    <center>
                        {{env('SYSTEM_CURRENCY', '₺')}}{{$item->quantity * $item->price}}
                    </center>
                </td>
            </tr>
            @endforeach
            <tr class="total">
                ...
                <td>
                   <strong><center>{{env('SYSTEM_CURRENCY', '₺')}}{{ $student_store_commission }}</center></strong>
                </td>
            </tr>
            ...
            <tr class="total">
                ...
                <td>
                   <strong><center>{{env('SYSTEM_CURRENCY', '₺')}}{{ $cool_company_commission }}</center></strong>
                </td>
            </tr>
            ...
            <tr class="total">
                ...
                <td>
                   <strong><center>{{env('SYSTEM_CURRENCY', '₺')}}{{ $total_earned_reward_points * $appsetting->single_rewards_pt_value }}</center></strong>
                </td>
            </tr>
            @endif
            ...
            <tr class="total">
                ...
                <td>
                   <strong><center>{{env('SYSTEM_CURRENCY', '₺')}}{{ $amount_transferred_to_vendor }}</center></strong>
                </td>
            </tr>
            ...
            <tr class="total">
                ...
                <td>
                   <strong><center>{{env('SYSTEM_CURRENCY', '₺')}}{{$order->grand_total}}</center></strong>
                </td>
            </tr>
        </table>
    </div>
