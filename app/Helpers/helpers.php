...
function refund($refundOrderItemId,$refundOrderItemPrice,$refundOrderItemQuantity,$refundOrderItemReason)
{
    ...
    $body =  'We have completed your request for refund. '.env('SYSTEM_CURRENCY', '₺').''. ($refundOrderItemPrice * $refundOrderItemQuantity).' has been refunded to your selected payment method. For any questions, please contact admin with reference number '.$refund_id;
