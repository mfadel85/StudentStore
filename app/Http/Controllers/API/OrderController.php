...
class OrderController extends Controller
{
			...
			$orderObj = [
			  'payment' =>  [
			    ...
			    'urls' => [
			      ...
			      'paymentUrl' => env('FRONT_APP_URL').'perform-payment/'.$order_id,
			      'completeUrl' => env('FRONT_APP_URL').'payment-completed/'.$order_id,
			      'cancelUrl' => env('FRONT_APP_URL').'payment-canceled/'.$order_id,
			      'callbackUrl' => env('APP_URL').'swish-payment-callback',
			      'logoUrl' => $getAppSetting->logo_path,
			      'termsOfServiceUrl' => env('FRONT_APP_URL').'page/privacy-policy',
			    ],
			    'payeeInfo' =>  [
			...
			$orderObj = [
			  'paymentorder' =>  [
			    ...
			    'urls' => [
			      ...
			      'completeUrl' => env('FRONT_APP_URL').'payment-completed',
			      'cancelUrl' => env('FRONT_APP_URL').'payment-canceled',
			      'paymentUrl' => env('FRONT_APP_URL').'perform-payment',
			      'callbackUrl' => env('APP_URL').'swish-payment-callback',
			      'termsOfServiceUrl' => env('FRONT_APP_URL').'page/privacy-policy',
			      'logoUrl' => $getAppSetting->logo_path,
			    ],
	...
	public function getSwishTransactions(Request $request, $transaction_token)
	{
		$accessToken = $this->paymentInfo->swish_access_token;
        ...
        return response()->json(prepareResult(false, $returnData, "Swedbankpay successfully fetch transaction info."), config('http_response.success'));
	}
}
